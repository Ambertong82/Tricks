...
class AnalyzerConfig:
    # sol: str = "/media/amber/PhD_data_xtsun/PhD/Bonnecaze/Middle_particle23/case230427_4"
    sol: str = "/media/amber/PhD_data_xtsun/PhD/Bonnecaze/Fine_particle9/case090912_1"
    # output_dir: str = "/home/amber/postpro/POD/u_umean_tc2dcoarse"
    output_dir: str = "/home/amber/postpro/POD/u_umean_tc2dfine"
    alpha_threshold: float = 1e-5
    y_min: float = 0.0
    times: Iterable[int] = (7, 10, 12)
...
class TurbidityCurrentAnalyzer:
    ...
    def _process_time_step(self, X, Y, Z, time_v):
        ...
        markers = {
            "$0.1H_0$": head_x - 0.1 * self.cfg.head_height,
            "$0.25H_0$": head_x - 0.25 * self.cfg.head_height,
            "$0.5H_0$": head_x - 0.5 * self.cfg.head_height,
