...
for file in file_list:
    ...
    if len(filtered_df) > 1:
        ...
        grad_Ubvx = df.loc[(df['Points:0'] == x) & (
            df['Points:2'] == 0), 'grad(U.b):1']
        grad_Ubuy = df.loc[(df['Points:0'] == x) & (
            df['Points:2'] == 0), 'grad(U.b):3']
        ubh = yvalue * uavalue
        ...
        # data_dict7.append([time, x] + rigA_values)
        data_dict8.append([time, x] + drhody)
        data_dict9.append([time, x] + grad_Ub)
        data_dict10.append([time, x] + ALPHA)
        data_dict11.append([time, x] + E_ins)

data_df = pd.DataFrame(data_dict).transpose()
data_df.to_csv('/home/amber/postpro/case230427_4_x14xyy.csv', index=False, header=False)
data2_df = pd.DataFrame(data_dict2).transpose()
data2_df.to_csv('/home/amber/postpro/case230427_4_x14xua.csv', index=False, header=False)
data3_df = pd.DataFrame(data_dict3).transpose()
data3_df.to_csv('/home/amber/postpro/case230427_4_x14xub.csv', index=False, header=False)
data4_df = pd.DataFrame(data_dict4).transpose()
data4_df.to_csv('/home/amber/postpro/case230427_4_x14xRig.csv', index=False, header=False)
data5_df = pd.DataFrame(data_dict5).transpose()
data5_df.to_csv('/home/amber/postpro/case230427_4_x14xRigg.csv', index=False, header=False)
data6_df = pd.DataFrame(data_dict6).transpose()
data6_df.to_csv('/home/amber/postpro/case230427_4_x14xomegaz.csv', index=False, header=False)
# data7_df = pd.DataFrame(data_dict7).transpose()
# data7_df.to_csv('case230429_5_x14xRigA[040].csv', index=False, header=False)
data8_df = pd.DataFrame(data_dict8).transpose()
data8_df.to_csv('/home/amber/postpro/case230427_4_x14drhody.csv', index=False, header=False)
data9_df = pd.DataFrame(data_dict9).transpose()
data9_df.to_csv('/home/amber/postpro/case230427_4_x14grad_Ub.csv', index=False, header=False)
data10_df = pd.DataFrame(data_dict10).transpose()
data10_df.to_csv('/home/amber/postpro/case230427_4_x14ALPHA.csv', index=False, header=False)
